...
const zhCN = {
  ...
  "nav.search": "全局搜索",
  "nav.materials": "资料库",
  "nav.domainGraph": "领域知识图谱",
  "nav.personalModel": "个人模型",
  "nav.studentGraph": "学生知识图谱",
  "nav.learningPath": "学习路径",
  "nav.history": "版本记录",
  "nav.settings": "设置",
  "shell.productTagline": "认知学习工作台",
  "shell.noWorkspace": "未选择学习空间",
  "shell.learner": "学习者：{name}",
...
const en: Record<keyof typeof zhCN, string> = {
  ...
  "shell.productTagline": "Personal learning workspace",
  "shell.noWorkspace": "No workspace selected",
  "shell.learner": "Learner: {name}",
